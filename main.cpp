...
int main(int argc, char *argv[]) {
    ...
    options.add_options()
            ...
            ("t1", "Block Merge Support site count for hete", cxxopts::value<float>()->default_value("1"))
            ("t2", "Block Merge Support site count for homo", cxxopts::value<float>()->default_value("1"))
