class PhaseSetStats:
    def __init__(self, switch_count, mismatch_count, phased_snp, N50, AN50, spanned_snp, bnd_count, bnd_switched_error_count, bnd_missmatch_error_count):
        ...
        self.bnd_switched_error_count = bnd_switched_error_count
        self.bnd_missmatch_error_count = bnd_missmatch_error_count
...
class HapStats:
    ...
    def get_bnd_count(self):
        ...
        for phase_set_stats in self.phase_set_stats:
            total += phase_set_stats.bnd_count
        return total

    def get_bnd_switch(self):
        total = 0
        for phase_set_stats in self.phase_set_stats:
            total += phase_set_stats.bnd_switched_error_count
        return total

    def get_bnd_mismatch(self):
        total = 0
        for phase_set_stats in self.phase_set_stats:
            total += phase_set_stats.bnd_missmatch_error_count
        return total
