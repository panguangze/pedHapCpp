...
void Phaser::phasing()
{
    ...
    {
        auto tmpp = std::find(this->contigs.begin(), this->contigs.end(), frvcf->contigs[rid]) == this->contigs.end();
...
//        }
//    }
//chromoPhaser->correct_unphase(s_idx,f_idx,m_idx);
}